...
public class SubjectController {
    ...
    @PostMapping("/")
    public GenericResponse<Long> create(@RequestBody SubjectDto subjectDto) {
    ...
    @PutMapping("/")
    public GenericResponse<Long> update(@Parameter long id, @RequestBody SubjectDto subjectDto) {
    ...
    @GetMapping("/")
    public GenericResponse<SubjectDto> get(@Parameter long id) {
